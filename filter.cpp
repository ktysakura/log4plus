...
void test_1 (Logger & root, log4cplus::tstring const & file)
{
...
log4cplus::tstring getPropertiesFileArgument (int argc, char * argv[])
{
    ...
    return LOG4CPLUS_TEXT ("14_filter.properties");
}

// g++ -o 14_filter 14_filter.cpp -llog4cplus -std=c++11
// 运行：./14_filter
int log4cpp_filter(int argc, char * argv[])
{
